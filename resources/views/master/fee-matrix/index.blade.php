                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($feeMatrices as $matrix)
                                    <tr class="{{ $matrix->trashed() ? 'bg-gray-50' : '' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            @if($matrix->trashed())
                                                ...
                                                @can('master.fee-matrix.delete')
                                                    <form action="{{ route('master.fee-matrix.restore', $matrix->id) }}" method="POST"
                                                        class="inline-block" onsubmit="return confirm('Restore this fee matrix?');">
                                                        @csrf
                                                        <button type="submit"
