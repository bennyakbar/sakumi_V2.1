# Manual Flow Operasional Aplikasi SAKUMI (Input → Proses → Output Report → Evaluasi Keputusan)
  ...
  SAKUMI dipakai untuk mengelola keuangan sekolah per unit (MI, RA, DTA) dari data dasar sampai laporan
  manajerial untuk keputusan harian, mingguan, dan bulanan.
  ...
  ## Tahap F: Kwitansi & Kontrol Cetak
  ...
  ## Tahap G: Rekonsiliasi Bank & Expense Workflow
  ...
  - Realisasi pendapatan hari ini & bulan ini.
  ...
  2. Jika daily cash tidak cocok dengan fisik/bank: lakukan investigasi transaksi & rekonsiliasi.
